...
<head>
    ...
    <style>
        ...
        [data-kt-app-layout=dark-sidebar] .app-sidebar .menu>.menu-item.here>.menu-sub .menu-link .menu-title {
            color: #fff;
        }
        [data-kt-app-layout=dark-sidebar] .app-sidebar .menu>.menu-item.here>.menu-sub .menu-link .menu-icon{
            color: #fff;
        }
        [data-kt-app-layout=dark-sidebar] .app-sidebar .menu>.menu-item.here>.menu-sub .menu-link .menu-arrow{
            color: #fff;
        }
